...
torch.onnx.export(model,
                  ...
                  dynamic_axes={
                      ...
                      'past_key_values_0_key': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_0_value': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_1_key': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_1_value': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_2_key': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_2_value': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_3_key': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_3_value': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_4_key': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_4_value': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_5_key': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_5_value': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_6_key': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_6_value': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_7_key': {0: 'batch_size', 2: 'past_len'},
                      'past_key_values_7_value': {0: 'batch_size', 2: 'past_len'},
                      'logits' : {0: 'batch_size', 1: 'in_len'},
                      'present_0_key': {0: 'batch_size', 2: 'out_len'},
                      'present_0_value': {0: 'batch_size', 2: 'out_len'},
                      'present_1_key': {0: 'batch_size', 2: 'out_len'},
                      'present_1_value': {0: 'batch_size', 2: 'out_len'},
                      'present_2_key': {0: 'batch_size', 2: 'out_len'},
                      'present_2_value': {0: 'batch_size', 2: 'out_len'},
                      'present_3_key': {0: 'batch_size', 2: 'out_len'},
                      'present_3_value': {0: 'batch_size', 2: 'out_len'},
                      'present_4_key': {0: 'batch_size', 2: 'out_len'},
                      'present_4_value': {0: 'batch_size', 2: 'out_len'},
                      'present_5_key': {0: 'batch_size', 2: 'out_len'},
                      'present_5_value': {0: 'batch_size', 2: 'out_len'},
                      'present_6_key': {0: 'batch_size', 2: 'out_len'},
                      'present_6_value': {0: 'batch_size', 2: 'out_len'},
                      'present_7_key': {0: 'batch_size', 2: 'out_len'},
                      'present_7_value': {0: 'batch_size', 2: 'out_len'}
                  }
                 )